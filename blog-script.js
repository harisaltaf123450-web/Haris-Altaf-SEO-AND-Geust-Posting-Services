// Blog data with images and content
const blogsData = [
    {
        id: 1,
        title: 'Top 10 SEO Ranking Factors in 2024',
        date: 'August 15, 2024',
        image: 'https://via.placeholder.com/400x300/667eea/ffffff?text=SEO+Ranking+Factors',
        category: 'SEO Tips',
    ...
    },
    {
        ...
        date: 'August 10, 2024',
        image: 'https://via.placeholder.com/400x300/f093fb/ffffff?text=Link+Building',
    ...
    },
    {
        ...
        date: 'August 5, 2024',
        image: 'https://via.placeholder.com/400x300/4facfe/ffffff?text=Content+Strategy',
        ...
        <p>Ensure your content ranks for relevant keywords so potential customers can find you naturally.</p>
        
        <h3>Step 6: Include Clear Calls-to-Action</h3>
        <p>Every piece of content should guide readers toward the next step in your sales funnel. Use clear, compelling CTAs.</p>
        
        <h3>Step 7: Measure and Iterate</h3>
        ...
        <ul>
            <li>Blog posts (detailed and SEO-optimized)</li>
            <li>Case studies (proof of results)</li>
            <li>Webinars (build authority)</li>
            <li>Email sequences (nurture leads)</li>
            <li>Videos (high engagement)</li>
            <li>Whitepapers (lead magnets)</li>
        </ul>`
    },
    {
        id: 4,
        ...
        date: 'July 28, 2024',
        image: 'https://via.placeholder.com/400x300/a8edea/ffffff?text=Technical+SEO',
        ...
        <ul>
            <li>✓ Clear and logical site hierarchy</li>
            <li>✓ Proper use of H1, H2, H3 tags</li>
        ...
        <ul>
            ...
            <li>✓ Optimized images (compressed and properly formatted)</li>
            <li>✓ Minimized code (CSS, JavaScript, HTML)</li>
            <li>✓ Server response time (under 600ms)</li>
        ...
        <h3>Security</h3>
        <ul>
            <li>✓ HTTPS/SSL certificate installed</li>
        ...
        <ul>
            ...
            <li>✓ Sitemap.xml created and submitted</li>
            <li>✓ No duplicate content issues</li>
            <li>✓ Canonical tags properly set</li>
            <li>✓ Proper use of noindex and nofollow</li>
        </ul>
        
        <h3>Metadata</h3>
        <ul>
            <li>✓ Unique and descriptive title tags (50-60 characters)</li>
            <li>✓ Unique meta descriptions (150-160 characters)</li>
        ...
        <ul>
            ...
            <li>✓ Mobile-friendly test passed</li>
            <li>✓ No intrusive interstitials</li>
            <li>✓ Fast mobile load time</li>
            <li>✓ Proper mobile viewport settings</li>
        </ul>`
    },
    {
        id: 5,
        ...
        date: 'July 20, 2024',
        image: 'https://via.placeholder.com/400x300/fecba1/ffffff?text=Keyword+Research',
        category: 'SEO Basics',
        ...
        <p>Targeting the right keywords means:</p>
        <ul>
            <li>Attracting the right audience</li>
            <li>Ranking faster and easier</li>
            <li>Getting higher-quality traffic</li>
            <li>Improving conversion rates</li>
        </ul>
        
        <h3>Types of Keywords</h3>
        <p><strong>Short-tail keywords:</strong> 1-2 words with high volume but high competition</p>
        <p><strong>Long-tail keywords:</strong> 3+ words with lower volume but lower competition and higher intent</p>
        <p><strong>LSI keywords:</strong> Related keywords that search engines associate with your main keyword</p>
    ...
    },
    {
        ...
        date: 'July 12, 2024',
        image: 'https://via.placeholder.com/400x300/a1c4ff/ffffff?text=WordPress+SEO',
        category: 'WordPress',
        ...
        <h3>Essential WordPress SEO Plugins</h3>
        <ul>
            <li><strong>Yoast SEO:</strong> Comprehensive SEO plugin with keyword optimization tools</li>
            <li><strong>Rank Math:</strong> Alternative to Yoast with AI-powered features</li>
            <li><strong>All in One SEO:</strong> Lightweight and powerful SEO plugin</li>
            <li><strong>Akismet:</strong> Spam protection</li>
            <li><strong>WP Super Cache:</strong> Caching for faster performance</li>
        </ul>
        
        <h3>WordPress SEO Best Practices</h3>
        <ul>
            <li>Use an SEO-friendly theme</li>
            <li>Optimize your site structure</li>
            ...
            <li>Implement internal linking</li>
        </ul>`
    }
];
